...
import { Mail, Lock, Gamepad2, LogIn, UserPlus } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md mt-24">
        ...
        <div className="bg-black/60 backdrop-blur-xl border border-green-500/20 rounded-2xl shadow-[0_0_50px_rgba(74,222,128,0.15)] p-8 flex flex-col gap-5">
          <div className="text-center mb-4">
            <h2 className="text-3xl font-black text-white mb-2">خوش برگشتی!</h2>
            <p className="text-gray-400 text-sm">وارد حساب کاربریت شو</p>
          </div>
          ...
          <button
            ...
            className="relative mt-2 w-full bg-gradient-to-r cursor-pointer from-green-500 to-emerald-500 text-black py-4 rounded-xl font-black text-lg hover:from-green-400 hover:to-emerald-400 transition-all duration-300 shadow-[0_0_30px_rgba(74,222,128,0.4)] hover:shadow-[0_0_40px_rgba(74,222,128,0.6)] hover:scale-[1.02] overflow-hidden group"
          >
          ...
          <div className="flex items-center gap-4 my-2">
            ...
            <span className="text-gray-600 text-xs">یا ورود سریع با</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="px-4 py-3 bg-gray-900/50 border border-gray-800 rounded-xl text-gray-400 text-sm font-bold hover:border-green-500/30 hover:text-green-400 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <button
              type="button"
              className="px-4 py-3 bg-gray-900/50 border border-gray-800 cursor-pointer rounded-xl text-gray-400 text-sm font-bold hover:border-green-500/30 hover:text-green-400 transition-all duration-300 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          با ورود، شما <span className="text-green-400">قوانین و مقررات</span>{' '}
          را می‌پذیرید
        </p>
      </div>
      <style jsx>{`
