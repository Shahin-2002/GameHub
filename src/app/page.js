  ...
  const featuredGames = [
    {
      ...
      image: "https://th.bing.com/th/id/OIP.SDG4eXoY24IOdAYWsKvaXgHaEK?w=256&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",
      criticScore: 8.5,
      userScore: 7.8,
      reviews: 342,
      category: "RPG",
    ...
    },
    {
      ...
      image:
        "https://th.bing.com/th/id/OIP.JZktdCpH1WsAZcv-9wAcegHaEK?w=276&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",
      criticScore: 9.7,
      userScore: 9.2,
      reviews: 528,
    ...
    },
    {
      ...
      title: "Elden Ring",
      image:
        "https://th.bing.com/th/id/OIP.uv47fi4i16P5BP2PM6DjCgHaEK?w=265&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",
      criticScore: 9.6,
      userScore: 3.9,
      reviews: 612,
      category: "RPG",
  ...
  const games = [
    {
      ...
      image:
        "https://tse3.mm.bing.net/th/id/OIP.f_Mb8CFbewLPu1WMKiKEwwHaEK?rs=1&pid=ImgDetMain&o=7&rm=3",
      criticScore: 9.4,
      userScore: 9.1,
      reviews: 428,
      views: "1.2M",
    ...
    },
    {
      ...
      image:
        "https://th.bing.com/th/id/OIP.G4L3T372Ci6BQHNq3URKAwHaEK?w=330&h=185&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",
      criticScore: 9.6,
      userScore: 9.3,
      reviews: 892,
      views: "2.1M",
    ...
    },
    {
      ...
      image: "https://gamingbolt.com/wp-content/uploads/2023/11/the-last-of-us-part-2-remastered.jpg",
      criticScore: 9.3,
      userScore: 8.5,
      reviews: 734,
      views: "1.8M",
    ...
    },
    {
      ...
      title: "Spider-Man 2",
      image:
        "https://tse1.mm.bing.net/th/id/OIP.2ACxYgHiIYqf63qTkqlIeQHaEK?rs=1&pid=ImgDetMain&o=7&rm=3",
      criticScore: 9.0,
      userScore: 8.8,
      reviews: 456,
      views: "1.5M",
    ...
    },
    {
      ...
      image:
        "https://th.bing.com/th?id=OIF.eBq8QM%2bwBYfvgTfashOagQ&rs=1&pid=ImgDetMain&o=7&rm=3",
      criticScore: 8.4,
      userScore: 8.7,
      reviews: 621,
      views: "1.9M",
    ...
    },
    {
      ...
      title: "Starfield",
      image:
        "https://tse4.mm.bing.net/th/id/OIP.IO4iyaBFT_-klUlwc4I4mgHaEK?rs=1&pid=ImgDetMain&o=7&rm=3",
      criticScore: 8.7,
      userScore: 7.9,
      reviews: 512,
      views: "1.4M",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-8">
            بررسی‌های تخصصی، امتیازات منتقدین و نظرات کاربران درباره جدیدترین
            بازی‌ها
          </p>
          ...
          <div className="max-w-2xl mx-auto relative">
            <input
              ...
              className="w-full bg-gray-900/50 backdrop-blur-sm text-white px-6 py-4 pr-14 rounded-2xl border border-gray-800 focus:outline-none focus:border-green-500/50 focus:shadow-[0_0_30px_rgba(74,222,128,0.2)] placeholder-gray-500 transition-all duration-300"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {games.map((game, index) => (
            <div
              key={game.id}
              className="group bg-gray-900/30 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-800 hover:border-green-500/30 hover:bg-gray-900/50 transition-all duration-300 cursor-pointer"
            >
              <div className="flex gap-4 p-5">
                ...
                <div className="flex-shrink-0 w-24 h-24 rounded-xl overflow-hidden relative">
                  <img
                    src={game.image}
                    alt={game.title}
                    className="w-24 h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="text-lg font-black text-white mb-2 group-hover:text-green-400 transition-colors truncate">
                    {game.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    <div className="flex items-center gap-1">
                      ...
                      <span
                        className={`font-black text-sm ${getScoreColor(
                          game.criticScore
                        )}`}
                      >
                        {game.criticScore}
